...
export default function EstadisticasMensuales() {
  ...
  const exportToCSV = () => {
    ...
    let csvContent = "\uFEFF";
    csvContent += "REPORTES MENSUALES Y ACTIVIDAD HUASI - INDESCO & UCC\n\n";
    ...
    data.historico_alojamientos.forEach(a => {
      csvContent += `"${a.mes}",${a.nuevos_alojamientos}\n`;
    });
    ...
    link.setAttribute("download", `Reporte_Estadisticas_HUASI_UCC_${new Date().toISOString().slice(0, 10)}.csv`);
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
    showToast('Reporte mensual exportado en CSV', 'success');
  };
